...
import (
	...
	"github.com/hydruga/ultimate_service/app/business/data/schema"
	"github.com/hydruga/ultimate_service/app/business/sys/database"
)
...
func genToken() error {
	...
	claims := struct {
		jwt.StandardClaims // Imbedding - ie inner type promotion. We get all values for free of jwt.StandardClass this way
		Roles              []string
	}{
	...
	if err := pem.Encode(os.Stdout, &publicBlock); err != nil {
		return fmt.Errorf("encoding to a public file: %w", err)
	}

	//===========================================================

	// Create the token parser to use. The algorithm used to sign the JWT must be
	// validated to vaoid a critical vulnerability.
