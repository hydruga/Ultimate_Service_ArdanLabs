...
func New(activeKID string, keyLookup KeyLookup) (*Auth, error) {
	...
	if err != nil {
		return nil, errors.New("active KID does not exist in the store")
	}

	method := jwt.GetSigningMethod("RS256")
	if method == nil {
		return nil, errors.New("configuring algorithms RS256")
	}
	...
	// validated to avoid critical vulnerability.
	parser := jwt.Parser{
